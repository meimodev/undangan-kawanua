        ...
        return (
            <div className="bg-gray-50 rounded-xl shadow-xl p-4 overflow-hidden flex flex-col justify-between mb-5">
                <div className="flex ">
                    ...
                    <div className="mx-3 h-100 w-0.5 bg-divider rounded-full"/>
                    ...
                    <div className="relative h-96">
                        <div className="flex flex-col h-full justify-center">
                            <div className="w-full sm:w-1/2">
                                ...
                                <div className="bg-divider h-1 w-10 my-2 rounded-lg"/>
                                ...
                                <div className="flex gap-3">
                                    <div className="flex gap-1 p-2 bg-gray-100 shadow-sm rounded-md">
                        ...
                        <div className="absolute bottom-0 transform translate-y-5">
                            <div
                                className=" rounded-lg bg-gray-50 shadow-md hover:shadow-lg transition duration-300 overflow-hidden">
                                <div className="flex">
